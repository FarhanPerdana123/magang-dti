...
if ( ! class_exists( 'UGM_Faculty_Theme' ) ) {
	...
	class UGM_Faculty_Theme {
		...
		protected $module_files = array(
			...
			'core/theme-routes.php',
			'core/image-sizes.php',
			'core/enqueue.php',
			'core/widgets.php',
			'core/customizer.php',
			'core/security.php',
			'helpers/front-page-helpers.php',
			'meta/magazine-meta.php',
			'meta/landing-page-meta.php',
			'pages/landing-page.php',
			'pages/agenda-page.php',
			'pages/announcement-page.php',
			'pages/gallery-page.php',
			'pages/greeting-page.php',
			'pages/management-page.php',
			'editor/block-registration.php',
		);
