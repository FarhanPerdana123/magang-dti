...
function ugm_enqueue_assets() {
	...
	wp_enqueue_style(
		'ugm-google-fonts',
		'https://fonts.googleapis.com/css2?family=Albert+Sans:ital,wght@0,400;0,500;0,600;0,700;0,800;1,400;1,600;1,700&family=Open+Sans:ital,wght@0,400;0,500;0,600;0,700;1,400;1,600;1,700&display=swap',
		array(),
		null
	);
