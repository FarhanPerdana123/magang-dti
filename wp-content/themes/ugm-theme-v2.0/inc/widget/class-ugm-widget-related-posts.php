...
/**
 * Custom Related Post Widget
 *
 * 	Additional info about author post will be showed
 *
 * 	@since 1.0
 */
class UGM_Widget_Related_Posts extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array(
			...
			'description' 	=> __( "Related posts of current post, based on tag and category", "ugm-theme" )
		);
		parent::__construct( 'related-posts', __( 'Related Posts','ugm-theme'), $widget_ops );
	...
	public function widget( $args, $instance ) {
		...
		$title = ( ! empty( $instance['title'] ) ) ? $instance['title'] : __( 'Related Posts','ugm-theme');
		...
		$related_posts = ugm_get_related_post( get_the_ID(), $number );
		...
		<ul id="related-post-list" class="post-list">
