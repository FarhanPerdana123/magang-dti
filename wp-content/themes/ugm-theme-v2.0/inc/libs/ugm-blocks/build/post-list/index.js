...
/***/ "./src/post-list/controls/author-control.js":
/*!**************************************************!*\
  !*** ./src/post-list/controls/author-control.js ***!
  \**************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = (AuthorControl);

/***/ }),

/***/ "./src/post-list/controls/taxonomy-controls.js":
/*!*****************************************************!*\
  !*** ./src/post-list/controls/taxonomy-controls.js ***!
  \*****************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "TaxonomyControls": function() { return /* binding */ TaxonomyControls; }
/* harmony export */ });
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _wordpress_components__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @wordpress/components */ "@wordpress/components");
...
const useTaxonomyTerms = slug => {
  return (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_2__.useSelect)(select => {
    const terms = select(_wordpress_core_data__WEBPACK_IMPORTED_MODULE_3__.store).getEntityRecords('taxonomy', slug, {
      context: 'view',
      per_page: 100
    });
    return {
...
function TaxonomyControls(_ref) {
  ...
  const taxonomies = (0,_utils__WEBPACK_IMPORTED_MODULE_4__.useTaxonomies)(postType);
...
/* harmony import */ var _wordpress_icons__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @wordpress/icons */ "./node_modules/@wordpress/icons/build-module/library/list.js");
/* harmony import */ var _wordpress_icons__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @wordpress/icons */ "./node_modules/@wordpress/icons/build-module/library/grid.js");
...
/* harmony import */ var _controls_author_control__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./controls/author-control */ "./src/post-list/controls/author-control.js");
/* harmony import */ var _controls_taxonomy_controls__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./controls/taxonomy-controls */ "./src/post-list/controls/taxonomy-controls.js");
...
function Edit(_ref) {
  ...
  const displayLayoutControls = [{
    ...
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Grid view'),
    onClick: () => updateDisplayLayout('grid'),
    isActive: layout === 'grid'
  }];
  const orderOptions = [{
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Newest to oldest'),
    value: 'date/desc'
  }, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Oldest to newest'),
    value: 'date/asc'
  }, {
    /* translators: label for ordering posts by title in ascending order */
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('A → Z'),
    value: 'title/asc'
  }, {
    /* translators: label for ordering posts by title in descending order */
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Z → A'),
    value: 'title/desc'
  }];
  const [querySearch, updateQuerySearch] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(query.search);
  const taxonomies = (0,_utils_js__WEBPACK_IMPORTED_MODULE_9__.useTaxonomies)(postType);
  const updateColumnCount = newColumnCount => setAttributes({
    columnCount: newColumnCount
  });
  const updateDisplayLayout = newLayout => setAttributes({
    layout: newLayout
  });
  const updateShow = newShow => setAttributes({
    show: {
      ...show,
      ...newShow
    }
  });
  const updateShowAll = newShowAll => setAttributes({
    showAll: {
      ...showAll,
      ...newShowAll
    }
  ...
  const posts = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_2__.useSelect)(select => {
    ...
    if (taxQuery) {
      ...
      const builtTaxQuery = Object.entries(taxQuery).reduce((accumulator, _ref2) => {
        let [taxonomySlug, terms] = _ref2;
        const taxonomy = taxonomies?.find(_ref3 => {
          let {
            slug
          } = _ref3;
  ...
  }, [perPage, order, orderBy, clientId, authorIds, search, postType, taxQuery
  // restQueryArgs,
  ]);

  let wrapperClass = classnames__WEBPACK_IMPORTED_MODULE_8___default()('posts', "posts-" + layout, "column-" + columnCount, {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_5__.BlockControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.ToolbarGroup, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Dropdown, {
    ...
    renderToggle: _ref4 => {
      ...
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.ToolbarButton, {
        ...
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Display settings'),
        onClick: onToggle
      });
    },
    renderContent: () => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.BaseControl, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.ToggleControl, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Show Thumbnail', 'ugm-theme'),
      checked: show.thumbnail,
      onChange: value => updateShow({
        thumbnail: value
      })
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.ToggleControl, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Show Date', 'ugm-theme'),
      checked: show.date,
      onChange: value => updateShow({
        date: value
      })
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.ToggleControl, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Show Excerpt', 'ugm-theme'),
      checked: show.excerpt,
      onChange: value => updateShow({
        excerpt: value
      })
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.ToggleControl, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Show More Link', 'ugm-theme'),
      checked: showAll.active,
      onChange: value => updateShowAll({
        active: value
      })
    })))
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.ToolbarGroup, {
    controls: displayLayoutControls
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_5__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.PanelBody, {
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Settings', 'ugm-theme')
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Posts Count'),
    labelPosition: "edge",
    min: 1,
    max: 100,
    onChange: value => {
    ...
    value: perPage,
    isDragEnabled: false
  })), 'grid' === layout && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.BaseControl, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.__experimentalNumberControl, {
    __unstableInputWidth: "100px",
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Column Count', 'ugm-theme'),
    labelPosition: "edge",
    min: 1,
    max: 4,
    onChange: value => {
    ...
    __unstableInputWidth: "100px",
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Order by', 'ugm-theme'),
    value: `${orderBy}/${order}`,
  ...
  })), showAll.active && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.BaseControl, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.TextControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Show More URL', 'ugm-theme'),
    value: showAll.url,
    onChange: value => updateShowAll({
      url: value
    })
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.TextControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Show More Text', 'ugm-theme'),
    value: showAll.text,
    onChange: value => updateShowAll({
      text: value
    })
  })))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_5__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.__experimentalToolsPanel, {
    className: "block-library-query-toolspanel__filters",
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Filter Posts', 'ugm-theme'),
    resetAll: () => {
      updateQuery({
        author: '',
        parents: [],
  ...
  }, !!taxonomies?.length && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.__experimentalToolsPanelItem, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Taxonomies', 'ugm-theme'),
    hasValue: () => Object.values(taxQuery || {}).some(terms => !!terms.length),
    onDeselect: () => updateQuery({
      taxQuery: null
    })
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_controls_taxonomy_controls__WEBPACK_IMPORTED_MODULE_11__.TaxonomyControls, {
    onChange: updateQuery,
    query: query
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.__experimentalToolsPanelItem, {
    hasValue: () => !!authorIds,
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Authors', 'ugm-theme'),
    onDeselect: () => updateQuery({
      author: ''
    })
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_controls_author_control__WEBPACK_IMPORTED_MODULE_10__["default"], {
    value: authorIds,
    onChange: updateQuery
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.__experimentalToolsPanelItem, {
    hasValue: () => !!querySearch,
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Keyword', 'ugm-theme'),
    onDeselect: () => updateQuerySearch('')
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.TextControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Keyword', 'ugm-theme'),
    value: querySearch,
    onChange: updateQuerySearch
  })))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", blockProps, posts && posts.length && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Disabled, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "ugm-blocks-block-post-list"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: wrapperClass
  }, posts.map(post => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("article", {
    className: "post"
  }, show.thumbnail && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "post-img"
  ...
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h3", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
    href: post.link
  }, post.title.rendered)), show.date && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "post-date"
  }, (0,_wordpress_date__WEBPACK_IMPORTED_MODULE_7__.date)('d F Y', post.date))), show.excerpt && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "entry-content",
    dangerouslySetInnerHTML: {
      __html: posts[0].excerpt.rendered
    }
  }))))), showAll.active && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "btn-box"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
    href: showAll.url,
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.scss */ "./src/post-list/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./editor.scss */ "./src/post-list/editor.scss");
/* harmony import */ var _icons_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../icons.js */ "./src/icons.js");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./edit */ "./src/post-list/edit.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./block.json */ "./src/post-list/block.json");
/**
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_5__.name, {
  icon: _icons_js__WEBPACK_IMPORTED_MODULE_3__.postListIcon,
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getEntitiesInfo": function() { return /* binding */ getEntitiesInfo; },
/* harmony export */   "useTaxonomies": function() { return /* binding */ useTaxonomies; }
/* harmony export */ });
...
"use strict";
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"ugm-blocks/post-list","version":"0.1.0","title":"Posts List","category":"ugm","description":"List of posts","attributes":{"id":{"type":"string"},"layout":{"type":"string","default":"list"},"columnCount":{"type":"string","default":3},"queryId":{"type":"number"},"show":{"type":"object","default":{"thumbnail":true,"date":true,"excerpt":true}},"showAll":{"type":"object","default":{"active":false,"url":"","text":"Show More"}},"query":{"type":"object","default":{"perPage":3,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":true,"taxQuery":null,"parents":[]}},"style":{"type":"object","default":{"spacing":{"margin":{"bottom":"30px"}}}}},"supports":{"html":false,"spacing":{"margin":["top","bottom"]}},"textdomain":"ugm-theme","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["post-list/style-index"], function() { return __webpack_require__("./src/post-list/index.js"); })
