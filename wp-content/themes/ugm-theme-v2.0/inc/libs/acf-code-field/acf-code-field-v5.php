...
class acf_code_field extends acf_field {
	...
	*/
	...
	function render_field( $field ) {
		...
		$dir = get_template_directory().'/inc/libs/acf-code-field/';
	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		$dir = get_template_directory_uri().'/inc/libs/acf-code-field/';
		...
		$localized_values = array(
			'plugins_url' => get_template_directory_uri().'/inc/libs/acf-code-field/',
		);
